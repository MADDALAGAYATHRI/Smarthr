...
const RoleCard = ({ role, title, description, icon, onSelect }: RoleCardProps) => (
    <div
        ...
        className="bg-white p-8 rounded-xl shadow-lg hover:shadow-primary/20 border-2 border-slate-200 hover:border-primary focus:border-primary focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary hover:-translate-y-1 transition-all duration-300 cursor-pointer flex flex-col items-center text-center"
        role="button"
        tabIndex={0}
...
const RoleSelector = ({ onSelectRole }: RoleSelectorProps) => {
    return (
        <div className="flex flex-col items-center justify-center py-16 px-4 bg-gradient-to-b from-white to-slate-50 rounded-2xl">
            ...
            <div className="grid md:grid-cols-2 gap-8 w-full max-w-4xl">
                ...
                <RoleCard
                    ...
                    icon={<svg className="w-16 h-16" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path></svg>}
