...
export const GoogleIcon = () => (
    <svg className="w-5 h-5 mr-2" viewBox="0 0 48 48" aria-hidden="true">
        ...
        <path fill="#1976D2" d="M43.611 20.083H42V20H24v8h11.303c-.792 2.237-2.231 4.166-4.087 5.571l6.19 5.238C42.012 35.845 44 30.338 44 24c0-1.341-.138-2.65-.389-3.917z"></path>
    </svg>
);
